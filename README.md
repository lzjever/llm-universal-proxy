...
The current published container release is `v0.2.23`; Cargo package version
`0.2.24` is the next release identity, not a published container tag yet. For
production, pin `ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.23` or the
