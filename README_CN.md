...
正式 release 镜像发布在 `ghcr.io/agentsmith-project/llm-universal-proxy`。容器运行、Docker Compose、container smoke、Admin Dashboard 鉴权边界和 GHCR 发布策略都放在 [docs/container.md](./docs/container.md)。
