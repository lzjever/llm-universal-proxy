...
current release image and can be overridden with `LLMUP_IMAGE` when you need a
different pinned tag or digest. It references environment variables and does not
